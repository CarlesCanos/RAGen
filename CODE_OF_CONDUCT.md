...
privately through [GitHub private reporting](https://github.com/CarlesCanos/RAGen/security/advisories/new).
Begin the report title with `Code of Conduct` and include links or other relevant context.
Do not include sensitive details in a public issue or pull request.
...
available on the [Contributor Covenant website](https://www.contributor-covenant.org/translations).
